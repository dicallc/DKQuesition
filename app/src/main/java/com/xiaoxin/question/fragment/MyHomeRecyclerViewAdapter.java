package com.xiaoxin.question.fragment;
...
import com.xiaoxin.question.R;
import com.xiaoxin.question.fragment.dummy.DummyContent.DummyItem;
...
public class MyHomeRecyclerViewAdapter extends RecyclerView.Adapter<MyHomeRecyclerViewAdapter.ViewHolder> {
    ...
    public MyHomeRecyclerViewAdapter(List<DummyItem> items, HomeFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
